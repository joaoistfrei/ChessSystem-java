...
public class Board {
    ...
    public void placePiece(Piece piece, Position position){
        if(thereIsAPiece(position)){
            throw new BoardException("Error placing piece! Position " + position + " already taken!");
        }
    ...
    public Piece removePiece(Position position){
        if(!positionExists(position)){
            throw new BoardException("Error removing piece: position " + position + " not on the board!");
        }
